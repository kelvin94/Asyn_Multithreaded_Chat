            ...
            try {
                ...
                while (!((messagefromClient = (Message) in.readObject()).getMsgType().equalsIgnoreCase(disconnectType))) {
                    if (messagefromClient.getMsgType().equalsIgnoreCase(initType)) {
                        ...
                        if(!chmap.containsKey(targettedClient)) {
                            // tell the client try again later
                        }
                        ...
                        System.out.println(this.clientIdentifier + " is connected to server");
                        ...
                        System.out.println("Sending to IP: " + chmap.get(targettedClient).getIp() + " Msg: " + messagefromClient);
